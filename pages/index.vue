<template>
  <div class="tw-mx-auto tw-max-w-screen-2xl tw-pt-4">
    ...
    <nuxt-link to="/products/new"><button>Add Product</button></nuxt-link>
      ...
      <div
        ...
        <div class="tw-relative tw-w-full tw-h-full">
          ...
          <div class="tw-h-full tw-w-[50%] tw-z-30 tw-flex tw-flex-row-reverse  tw-absolute tw-right-0">
            <div class="tw-h-full tw-w-full tw-overflow-auto  tw-p-4 tw-relative tw-flex tw-flex-col tw-text[#5A5A5A]">
...
export default {
  ...
  async mounted() {
    ...
    console.log({"mounted products": this.products});
    console.log({"mounted product payload": this.$store.state.product});
